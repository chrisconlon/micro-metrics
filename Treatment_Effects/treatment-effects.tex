...
\begin{frame}
  ...
  \begin{itemize}
    \item How do changes in the governments ability to appropriate property affect property markets?
    ...
    \item IV Challenge: What's a ``good'' judge? Unlike Dobbie case, don't have large N of other cases. 
    \item But do observe many judge characteristics. 
   \end{itemize}
\end{frame}
