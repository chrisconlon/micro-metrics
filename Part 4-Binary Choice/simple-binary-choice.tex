...
\begin{eqnarray*}
\frac{\partial l }{\partial \beta} = \nabla_{\beta} \cdot l(\mathbf{y}; \beta) &=&  \sum_{i=1}^N  \underbrace{\left[ y_i \frac{ f(Z_i) }{ F(Z_i)}  -  (1-y_i) \frac{f(Z_i) }{1-F(Z_i)} \right]}_{\varepsilon_i} \cdot X_i \
\end{eqnarray*}
It is technically also a \alert{moment condition}. It is easy for the logit
\begin{eqnarray*}
 \nabla_{\beta} \cdot l(\mathbf{y}; \beta) &=&  \sum_{i=1}^N  \underbrace{\left[ y_i (1-F(Z_i)) -  (1-y_i) F(Z_i) \right]}_{\varepsilon_i} \cdot X_i 
\end{eqnarray*}
...
We could also take second derivatives
\begin{eqnarray*}
\frac{\partial l^2 }{\partial \beta \partial \beta'} = \nabla_{\beta}^2 \cdot l(\mathbf{y}; \beta) &=&  \sum_{i=1}^N  \underbrace{\left[ y_i \frac{ f(Z_i) }{ F(Z_i)}  -  (1-y_i) \frac{f(Z_i) }{1-F(Z_i)} \right]}_{\varepsilon_i} \cdot X_i 
\end{eqnarray*}
It is technically also a \alert{moment condition}
