...
In these notes we'll talk about these in the context of linear regression. 
}
...
\item In practice we often start with a functional form like:\\
 ...
 \item Helpful to review what we're really getting out of multivariate regression. [Much of this section taken from HTF]
\end{itemize}
\end{frame}
