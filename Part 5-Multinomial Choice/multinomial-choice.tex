...
\begin{document}
\title{Multinomial Choice/ Statistical Demand Models*}
\author{Charlie Murry}
\institute{Empirical Methods | Boston College}
\date{\today}

\frame{\titlepage \footnotesize \emph{*Based heavily on notes from Chris Conlon (NYU Stern).}}
